/*
 * Public API Surface of cap-authentication-firebase
 */
...
export * from './lib/components/forgot/forgot.component';
export * from './lib/components/log-out/log-out.component';
